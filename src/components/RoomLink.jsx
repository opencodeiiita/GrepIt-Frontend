...
const RoomLink = ({roomLink,setShowModal}) => {
  ...
  return (
    <div className='w-screen h-screen fixed top-0 bg-black/30 flex justify-center items-center'>
        <main className='bg-white  h-fit  rounded-lg shadow-md p-4 pb-12 mx-4 lg:w-1/4 md:w-2/4 sm:w-2/3'>
            ...
            <p className='text-left text-gray-500 font-medium text-base leading-6 max-w mt-4'>Copy this link and send it to people you want to join your room. Be sure to save it so you can use it later, too.</p>

            <main className='flex justify-between items-center bg-gray-100 p-3 rounded-md mt-5'>
                <p className=' text-gray-600 font-semibold line-clamp-1 text-left'>{roomLink}</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 hover:text-green-400 hover:cursor-pointer" onClick={copyToClipboard}>
